...
*   **Home page**
    ...
    ![Home page](screenshots/home_page.png_3.png)

*   **AI Copilot (prompt + response)**
    
    ![AI Copilot](screenshots/ai_copilot.png_3.png)

*   **ML Pricing Calculator (input + predicted cost)**
    
    ![ML Pricing Calculator](screenshots/ml_pricing.png_3.jpeg)

*   **Admin Panel → ML Model Card tab (R²/RMSE and all agent metrics)**
    
    ![ML Model Card](screenshots/model_card.png_3.png)

*   **Admin Panel → Add / Delete / Unlock user actions**
    
    ![Admin Users](screenshots/admin.users.png_3.jpeg)

*   **A triggered lockout message**
    
    ![Lockout Message](screenshots/lockout.png_3.jpeg)

*   **An OTP cooldown message**
    
    ![OTP Cooldown](screenshots/otp_cooldown.png_3.jpeg)
